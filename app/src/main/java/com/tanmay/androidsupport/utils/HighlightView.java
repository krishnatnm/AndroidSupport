...
class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth =
                resources.getDrawable(com.android.camera.R.drawable.camera_crop_width);
        mResizeDrawableHeight =
                resources.getDrawable(com.android.camera.R.drawable.camera_crop_height);
        mResizeDrawableDiagonal =
                resources.getDrawable(com.android.camera.R.drawable.indicator_autocrop);
    }
