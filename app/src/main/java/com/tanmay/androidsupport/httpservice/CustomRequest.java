...
public class CustomRequest extends JsonRequest<JSONArray> {
     ...
     * @param errorListener Error listener, or null to ignore errors.
     */
    public CustomRequest(String url, Response.Listener<JSONArray> listener,
     ...
     * @param errorListener Error listener, or null to ignore errors.
     */
    public CustomRequest(int method, String url, Response.Listener<JSONArray> listener,
                         Response.ErrorListener errorListener) {
     ...
     * @param method        the HTTP method to use
     * @param url           URL to fetch the JSON from
     * @param jsonRequest   A {@link JSONArray} to post with the request. Null is allowed
